...
if (inPages("/characters/")) {
  addStyle(`
    [data-testid="inspiration"][aria-checked="true"] {
      -moz-box-shadow: 0px 0px 57px 3px rgba(255, 246, 145, 0.9), 0px 0px 13px -3px rgba(255, 247, 247, 0.9);
      -webkit-box-shadow: 0px 0px 57px 3px rgba(255, 246, 145, 0.9), 0px 0px 13px -3px rgba(255, 247, 247, 0.9);
